...
namespace Colecoes
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            for(int i=1 ; i<=n; i++)
            {
                int b = i % 2 == 0;          //escreva o seu código nos espaços em branco
                b = b*2;
                Console.WriteLine( b);
            }
            // ******** - Operações com Array - ********
            ...
            // // System.Console.WriteLine($"Valor procurado {estadosDicionario[valorProcuradoDicionario]}");
            ...
            // {
            // System.Console.WriteLine(estadoEncontrado); // variavel estadoEncontrado retorna o próprio valor
            // }
            // {
